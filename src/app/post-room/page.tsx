...
const AMENITY_OPTIONS = [
  { value: 'Wi-Fi tốc độ cao', icon: Wifi },
  { value: 'Máy lạnh', icon: AirVent },
  { value: 'Máy nước nóng', icon: Bath },
  { value: 'Máy giặt', icon: WashingMachine },
  { value: 'Tủ lạnh', icon: Refrigerator },
  { value: 'Giường', icon: BedDouble },
  { value: 'Tủ quần áo', icon: Shirt },
  { value: 'Bếp riêng', icon: Utensils },
  { value: 'Giờ giấc tự do', icon: Clock },
  { value: 'Không chung chủ', icon: DoorOpen },
  { value: 'Khóa vân tay / Thẻ từ', icon: KeyRound },
  { value: 'Camera 24/7', icon: Camera },
  { value: 'Bảo vệ', icon: ShieldCheck },
  { value: 'Chỗ để xe rộng rãi', icon: Car },
  { value: 'Ổ sạc xe điện', icon: BatteryCharging },
  { value: 'Thang máy', icon: Building2 },
  { value: 'Vệ sinh khu vực chung', icon: Sparkles },
  { value: 'Ban công / Cửa sổ lớn', icon: Wind },
  { value: 'Cho phép nuôi thú cưng', icon: PawPrint },
